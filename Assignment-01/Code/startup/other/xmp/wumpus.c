...
int32_t board_PlacePlayer(struct s0* rdi, struct s0* rsi) {
    ...
    v3 = rsi;
    if (*reinterpret_cast<int32_t*>(&v3) < 0 || (*reinterpret_cast<int32_t*>(&v3) > 4 || (*reinterpret_cast<int32_t*>(&v3 + 1) < 0 || (*reinterpret_cast<int32_t*>(&v3 + 1) > 4 || (rdx4 = *reinterpret_cast<int32_t*>(&v3 + 1), !!*reinterpret_cast<struct s0**>(((rdx4 << 2) + rdx4 << 2) + reinterpret_cast<uint32_t>(rdi) + *reinterpret_cast<int32_t*>(&v3) * 4)) && (rdx5 = *reinterpret_cast<int32_t*>(&v3 + 1), *reinterpret_cast<struct s0**>(((rdx5 << 2) + rdx5 << 2) + reinterpret_cast<uint32_t>(rdi) + *reinterpret_cast<int32_t*>(&v3) * 4) != 1))))) {
        eax6 = 0;
    } else {
        rdx7 = *reinterpret_cast<int32_t*>(&v3 + 1);
        *reinterpret_cast<struct s0**>(((rdx7 << 2) + rdx7 << 2) + reinterpret_cast<uint32_t>(rdi) + *reinterpret_cast<int32_t*>(&v3) * 4) = reinterpret_cast<struct s0*>(5);
        eax6 = 1;
    }
    return eax6;
}

int64_t putchar = 0x4007f6;

void fun_4007f0(void* rdi, struct s0* rsi, struct s0* rdx, ...) {
    goto putchar;
}

int64_t printf = 0x400846;

void fun_400840(int64_t rdi, struct s0* rsi, ...) {
    goto printf;
}

int64_t puts = 0x400816;

void fun_400810(int64_t rdi, struct s0* rsi, struct s0* rdx, struct s0* rcx) {
    goto puts;
}
...
void board_DisplayWarnings(struct s0* rdi, struct s0* rsi) {
    ...
    if (v7) {
        fun_400840("You feel a breeze! ", rsi, "You feel a breeze! ", rsi);
    }
    if (v6) {
        fun_400840("You hear flapping! ", rsi, "You hear flapping! ", rsi);
    }
    if (v5) {
        fun_400840("You smell a wumpus!", rsi, "You smell a wumpus!", rsi);
    }
    fun_4007f0(10, rsi, rdx11, 10, rsi, rdx11);
    return;
}

void* fun_4008e0(void* rdi, struct s0* rsi, struct s0* rdx);

int32_t fun_4008b0(void* rdi, struct s0* rsi, struct s0* rdx);
...
int32_t game_CommandLoad(void* rdi, struct s0* rsi, struct s0* rdx) {
    ...
    fun_4008e0(rdi, " ", rdx);
    rax4 = fun_4008e0(0, 0x402062, rdx);
    if (rax4) {
        eax5 = fun_4008b0(rax4, reinterpret_cast<int64_t>(__zero_stack_offset()) - 8 + 0xffffffffffffffe8, 10);
            ...
            if (rax14) {
                ...
                *reinterpret_cast<int32_t*>(&v9 + 1) = eax16;
                if (rax14 == v17 || ((eax18 = *v19, !!*reinterpret_cast<signed char*>(&eax18)) || (*reinterpret_cast<int32_t*>(&v9 + 1) < 0 || *reinterpret_cast<int32_t*>(&v9 + 1) > 4))) {
                    ...
                    if (!eax20) {
                        fun_400810("Unable to place player at that position. \n", v9, v9, rcx15);
                    } else {
...
int64_t strcmp = 0x400896;

int32_t fun_400890(void* rdi, struct s0* rsi, struct s0* rdx) {
    goto strcmp;
}
...
int32_t game_CommandShoot(void* rdi, struct s0* rsi, struct s0* rdx, struct s0* rcx) {
    ...
    if (rax6) {
        ...
        *reinterpret_cast<int32_t*>(&rsi7 + 1) = 0;
        eax8 = fun_400890(rax6, "north", rdx);
        if (!eax8 || (*reinterpret_cast<int32_t*>(&rsi7) = reinterpret_cast<int32_t>("n"), *reinterpret_cast<int32_t*>(&rsi7 + 1) = 0, eax9 = fun_400890(rax6, "n", rdx), !eax9)) {
            v10 = 0;
        } else {
            *reinterpret_cast<int32_t*>(&rsi7) = reinterpret_cast<int32_t>("south");
            *reinterpret_cast<int32_t*>(&rsi7 + 1) = 0;
            eax11 = fun_400890(rax6, "south", rdx);
            if (!eax11 || (*reinterpret_cast<int32_t*>(&rsi7) = reinterpret_cast<int32_t>("s"), *reinterpret_cast<int32_t*>(&rsi7 + 1) = 0, eax12 = fun_400890(rax6, "s", rdx), !eax12)) {
                v10 = 2;
            } else {
                *reinterpret_cast<int32_t*>(&rsi7) = reinterpret_cast<int32_t>("east");
                *reinterpret_cast<int32_t*>(&rsi7 + 1) = 0;
                eax13 = fun_400890(rax6, "east", rdx);
                if (!eax13 || (*reinterpret_cast<int32_t*>(&rsi7) = reinterpret_cast<int32_t>("e"), *reinterpret_cast<int32_t*>(&rsi7 + 1) = 0, eax14 = fun_400890(rax6, "e", rdx), !eax14)) {
                    v10 = 1;
                } else {
                    *reinterpret_cast<int32_t*>(&rsi7) = reinterpret_cast<int32_t>("west");
                    *reinterpret_cast<int32_t*>(&rsi7 + 1) = 0;
                    eax15 = fun_400890(rax6, "west", rdx);
                    if (!eax15 || (*reinterpret_cast<int32_t*>(&rsi7) = reinterpret_cast<int32_t>("w"), *reinterpret_cast<int32_t*>(&rsi7 + 1) = 0, eax16 = fun_400890(rax6, "w", rdx), !eax16)) {
                        v10 = 3;
                    } else {
    ...
    if (rdx->f8) {
        ...
        if (eax20 == 1) {
            fun_400810("You killed the Wumpus!\n", rax19, rax19, rcx);
            ...
            *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rax21) + 4) = 0;
            ...
            if (eax20 < 1) {
                ...
                *reinterpret_cast<int32_t*>(&rsi23 + 1) = 0;
                fun_400840("Missed. You now have %d arrows\n\n", rsi23);
            } else {
                if (eax20 != 2) {
                    fun_400850("FALSE", "game.c", 0xc9, "game_CommandShoot");
                } else {
                    fun_400810("Unable to fire arrow in that direction. \n", rax19, rax19, rcx);
                }
            }
        }
        eax17 = v5;
    } else {
        fun_400810("You don't have any arrows to fire.\n", rsi7, rdx, rcx);
        eax17 = 0;
    }
    addr_401567_11:
    return eax17;
...
int32_t fun_400800(void* rdi, struct s0* rsi, struct s0* rdx);
...
void game_Hunt(struct s0* rdi, struct s0* rsi) {
    ...
    while (v6) {
        ...
        eax10 = fun_400890(reinterpret_cast<int64_t>(rbp3) - 80, "north", 52);
        if (!eax10 || (eax11 = fun_400890(reinterpret_cast<int64_t>(rbp3) - 80, "n", 52), !eax11)) {
            v12 = 0;
        } else {
            eax13 = fun_400890(reinterpret_cast<int64_t>(rbp3) - 80, "south", 52);
            if (!eax13 || (eax14 = fun_400890(reinterpret_cast<int64_t>(rbp3) - 80, "s", 52), !eax14)) {
                v12 = 2;
            } else {
                eax15 = fun_400890(reinterpret_cast<int64_t>(rbp3) - 80, "east", 52);
                if (!eax15 || (eax16 = fun_400890(reinterpret_cast<int64_t>(rbp3) - 80, "e", 52), !eax16)) {
                    v12 = 1;
                } else {
                    eax17 = fun_400890(reinterpret_cast<int64_t>(rbp3) - 80, "west", 52);
                    if (!eax17 || (eax18 = fun_400890(reinterpret_cast<int64_t>(rbp3) - 80, "w", 52), !eax18)) {
                        v12 = 3;
                    } else {
                        *reinterpret_cast<uint32_t*>(&rdx7) = 5;
                        *reinterpret_cast<int32_t*>(&rdx7 + 1) = 0;
                        eax19 = fun_400800(reinterpret_cast<int64_t>(rbp3) - 80, "shoot", 5);
                        if (eax19) {
                            *reinterpret_cast<int32_t*>(&rsi) = reinterpret_cast<int32_t>("quit");
                            *reinterpret_cast<int32_t*>(&rsi + 1) = 0;
                            rdi20 = reinterpret_cast<void*>(reinterpret_cast<int64_t>(rbp3) - 80);
                            eax21 = fun_400890(rdi20, "quit", 5);
                            if (!eax21) 
                                goto addr_401870_13;
...
int64_t clearerr = 0x4008c6;

void fun_4008c0(struct s0* rdi) {
    goto clearerr;
}

int64_t fun_400880(struct s0* rdi, int64_t rsi, struct s0* rdx);

void* fun_400820(struct s0* rdi, int64_t rsi, struct s0* rdx);
...
int32_t readInput(struct s0* rdi, int32_t esi, struct s0* rdx, ...) {
    ...
    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rsi4) + 4) = 0;
    rax5 = fun_400880(rdi, rsi4, rdx);
    if (rax5) {
        rax6 = fun_400820(rdi, rsi4, rdx);
...
uint32_t board_FireArrow(struct s0* rdi, struct s0* rsi) {
    ...
    v3 = rsi;
    if (*reinterpret_cast<int32_t*>(&v3 + 1) < 0 || (*reinterpret_cast<int32_t*>(&v3 + 1) > 4 || (*reinterpret_cast<int32_t*>(&v3) < 0 || *reinterpret_cast<int32_t*>(&v3) > 4))) {
        eax4 = 2;
    } else {
        rdx5 = *reinterpret_cast<int32_t*>(&v3 + 1);
        if (reinterpret_cast<uint32_t>(*reinterpret_cast<struct s0**>(((rdx5 << 2) + rdx5 << 2) + reinterpret_cast<uint32_t>(rdi) + *reinterpret_cast<int32_t*>(&v3) * 4)) <= 3) {
            eax4 = 0;
        } else {
            if (*reinterpret_cast<struct s0**>(((rdx5 << 2) + rdx5 << 2) + reinterpret_cast<uint32_t>(rdi) + *reinterpret_cast<int32_t*>(&v3) * 4) == 4) {
                eax4 = 1;
            } else {
...
void board_Display(struct s0* rdi, struct s0* rsi, struct s0* rdx) {
    ...
    while (v6 <= 4) {
        ...
        *reinterpret_cast<int32_t*>(&rsi + 1) = 0;
        ...
        v8 = 0;
        while (v8 <= 4) {
            fun_4007f0(0x7c, rsi, rdx, 0x7c, rsi, rdx);
            rdx9 = v6;
        ...
        fun_400810("|", rsi, rdx, "board_Display");
        ++v6;
    }
    fun_400840("  -", rsi, "  -", rsi);
    v11 = 0;
    ...
    fun_4007f0(10, rsi, rdx, 10, rsi, rdx);
    return;
}
...
void fun_400830(int64_t rdi, int64_t rsi);
...
struct s0* player_GetNextPosition(struct s0* rdi, uint32_t esi) {
    ...
    v3 = rdi;
    if (esi == 1) {
        *reinterpret_cast<int32_t*>(&v3) = *reinterpret_cast<int32_t*>(&v3) + 1;
    } else {
        if (esi < 1) {
...
int32_t game_AttemptLoadCommand(struct s0* rdi, int64_t rsi, struct s0* rdx) {
    ...
    return eax12;
    addr_401042_6:
    fun_400810("Board successfully loaded\n", v5, v5, rcx6);
    eax12 = 1;
    goto addr_401071_9;
}

int64_t fgets = 0x400886;
...
int64_t getInput(struct s0* rdi, struct s0* rsi, int32_t edx) {
    ...
    v5 = rsi;
    v6 = edx;
    while (fun_400840("%s", v4, "%s", v4), rdx7 = stdin, *reinterpret_cast<int32_t*>(&rcx8) = v6, *reinterpret_cast<int32_t*>(&rcx8 + 1) = 0, *reinterpret_cast<int32_t*>(&rsi9) = *reinterpret_cast<int32_t*>(&rcx8), *reinterpret_cast<int32_t*>(&rsi9 + 1) = 0, eax10 = readInput(v5, *reinterpret_cast<int32_t*>(&rsi9), rdx7), fun_4007f0(10, rsi9, rdx7), eax10 != 2) {
...
int64_t strlen = 0x400826;

void* fun_400820(struct s0* rdi, int64_t rsi, struct s0* rdx) {
    goto strlen;
}

int64_t setbuf = 0x400836;

void fun_400830(int64_t rdi, int64_t rsi) {
    goto setbuf;
}

int64_t _IO_getc = 0x4008d6;
...
int64_t main() {
    ...
    while (v2) {
        ...
        *reinterpret_cast<int32_t*>(&rsi3 + 1) = 0;
        ...
        fun_4007f0(10, 3, rdx4, 10, 3, rdx4);
        if (eax6 == 2) {
